...
var wrapCacheEntry = function (entry) {
    ...
    var expirySeconds = Math.min(expiresInTime, entry.decodedToken.claims.exp) - 60; // take off a small leeway
    return {
        body: entry,
...
var kRequire = kIsNodeJS && typeof module.require === 'function' ? module.require : null; // eslint-disable-line
function browserDecodeBase64(base64, enableUnicode) {
    var binaryString = atob(base64);
    if (enableUnicode) {
        var binaryView = new Uint8Array(binaryString.length);
        Array.prototype.forEach.call(binaryView, function (el, idx, arr) {
...
function createBase64WorkerFactory(base64, sourcemap, enableUnicode) {
    if (sourcemap === void 0) { sourcemap = null; }
    if (enableUnicode === void 0) { enableUnicode = false; }
    var source = kIsNodeJS ? nodeDecodeBase64(base64, enableUnicode) : browserDecodeBase64(base64, enableUnicode);
    var start = source.indexOf('\n', 10) + 1;
    var body = source.substring(start) + (sourcemap ? "//# sourceMappingURL=" + sourcemap : '');
    if (kRequire) {
        /* node.js */
        var Worker_3 = kRequire('worker_threads').Worker; // eslint-disable-line
        return function WorkerFactory(options) {
            return new Worker_3(body, Object.assign({}, options, { eval: true }));
        };
    }
    /* browser */
...
/* eslint-disable */
var WorkerFactory = createBase64WorkerFactory('', null, false);
/* eslint-enable */
...
var Auth0Client = /** @class */ (function () {
    function Auth0Client(options) {
        ...
        if (this.options.useRefreshTokens) {
            this.options.scope = getUniqueScopes(this.options.scope, 'offline_access');
        }
    ...
    Auth0Client.prototype._getParams = function (authorizeOptions, state, nonce, code_challenge, redirect_uri) {
        var _a = this.options, domain = _a.domain, leeway = _a.leeway, useRefreshTokens = _a.useRefreshTokens, cacheLocation = _a.cacheLocation, withoutDomain = __rest(_a, ["domain", "leeway", "useRefreshTokens", "cacheLocation"]);
    ...
    Auth0Client.prototype.getTokenSilently = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = __assign({ audience: this.options.audience, scope: getUniqueScopes(this.DEFAULT_SCOPE, this.options.scope, options.scope), ignoreCache: false }, options), ignoreCache = _a.ignoreCache, getTokenOptions = __rest(_a, ["ignoreCache"]);
                        _c.label = 1;
                    case 1:
    ...
    Auth0Client.prototype._getTokenFromIFrame = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var stateIn, nonceIn, code_verifier, code_challengeBuffer, code_challenge, params, url, timeout, codeResult, tokenResult, decodedToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        stateIn = encode(createRandomString());
    ...
    Auth0Client.prototype._getTokenUsingRefreshToken = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var cache, redirect_uri, tokenResult, e_2, decodedToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options.scope = getUniqueScopes(this.DEFAULT_SCOPE, this.options.scope, options.scope);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (auth0.cacheLocation === CACHE_LOCATION_MEMORY &&
